...
public class Hit {
	...
	_highlightResult _highlightResultObject;
	...
	public _highlightResult get_highlightResultObject() {
		return _highlightResultObject;
	}
	public void set_highlightResultObject(_highlightResult _highlightResultObject) {
